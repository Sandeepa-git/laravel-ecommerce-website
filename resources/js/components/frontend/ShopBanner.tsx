...
export default function ShopBanner(): JSX.Element {
  ...
  return (
    <section
      className="relative w-full overflow-hidden h-screen max-h-[500px] min-h-[100px] border-2 mt-8 border-gray-300 rounded-2xl shadow"
              ...
              <div className="container mx-auto h-full flex items-center px-4 md:px-8">
                ...
                >
                  <div className="backdrop-blur-sm bg-white/30 p-6 md:p-8 lg:p-10 rounded-2xl shadow-xl border border-white/50">
                    ...
                    {/* Title */}
                    <h2
                      className={`text-3xl md:text-4xl font-bold mb-4 leading-tight ${slide.textColor}`}
                    >
                      {slide.title}
                    </h2>
